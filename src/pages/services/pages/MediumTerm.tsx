...
//   const para = ""
//   const para1 = "At Nirava , we provide Medium Term Accommodation (MTA) for individuals who need a safe and comfortable place to stay while waiting for a long-term housing solution. Whether you’re transitioning between homes, waiting for home modifications, or need temporary care, our MTA services ensure you have the right support in a welcoming environment."
//   const highlightedWords = ['Nirava ', 'Medium Term Accommodation', 'MTA', 'NDIS funding available for up to 90 days', 'temporary accommodation', 'Get in touch with us today ',
...
//   const para3 = "If you or your loved one needs temporary accommodation, Nirava  is here for you. Get in touch with us today to learn more about our MTA services and how we can assist you in finding the perfect place to stay."
