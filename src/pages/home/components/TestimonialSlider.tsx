    ...
    <section className="bg-white py-20 px-6 font-sans">
      ...
      <h2 className="text-3xl md:text-4xl font-serif font-bold text-[#333333] mb-16">
        ...
        <div className="relative flex items-center">
          ...
          <button
            onClick={prev}
            className="absolute left-0 z-20 bg-red-700 text-white rounded-full w-10 h-10 flex items-center justify-center shadow hover:bg-red-700"
          >
            ‹
          </button>
          ...
          <button
            onClick={next}
            className="absolute right-0 z-20 bg-red-700 text-white rounded-full w-10 h-10 flex items-center justify-center shadow hover:bg-red-700"
          >
            ›
          </button>
        </div>
