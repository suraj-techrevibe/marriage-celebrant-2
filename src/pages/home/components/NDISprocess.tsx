  ...
  return (
    <section className="bg-white py-20 px-6 font-sans">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="mt-12">
          <Link to="/services">
            <button className="bg-red-500 hover:bg-red-600 text-white font-bold py-4 px-12 rounded-full shadow-lg transition-all duration-300 uppercase text-xs tracking-[0.2em]">
              Learn More
            </button>
          </Link>
        </div>
