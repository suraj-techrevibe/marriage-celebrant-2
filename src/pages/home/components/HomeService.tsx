...
//                   <Link
//                     to={service.link}
//                     className="inline-block text-red-600 font-bold text-sm hover:underline pt-2"
//                   >
//                     Read More
//                   </Link>
//                 </div>
...
//           <Link to="/services">
//             <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-4 px-10 rounded-full transition-colors uppercase text-sm tracking-widest">
