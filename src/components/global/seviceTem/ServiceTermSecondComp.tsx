...
const ServiceTermSecondComp: React.FC<ServiceTemplateProps> = ({
  heading,
  para,
  img,
  imgTitle,
  ...
  return (
    <section className="bg-white py-16 px-6 max-w-7xl mx-auto">
      <div className="flex flex-col lg:flex-row gap-12 items-start">
        ...
        <img
  src={Array.isArray(img) ? img[0] : img}  // ensures string
  alt={imgTitle ?? "image"}                // default alt text
...
export default ServiceTermSecondComp;